                     ...
                     <div key={index}>
                        <div className="mt-10 mb-32 md:mb-0">
                           ...
                           <div className="mt-10 text-center">
                              <a href="tel:+13108159000" className="uppercase font-poppins font-semibold text-white bg-primaryGreen hover:bg-primaryBlue transition-all rounded-3xl px-5 py-2">contact us</a>
                           </div>
                        </div>
                     </div>
                  ))
